...
export const testData = {
  incomes: [
    new Income('1', new Date(), 2340, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('2', new Date(), 5547, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('3', new Date(), 154474, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('4', new Date(), 22103, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('5', new Date(), 1881, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('6', new Date(), 111, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('7', new Date(), 111, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('8', new Date(), 111, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('9', new Date(), 111, 'heyho', new Account('helo'), new IncomeCategory('Cat 1')),
    new Income('10', new Date(), 222, 'blabla', new Account('bla'), new IncomeCategory('Cat 2'))
  ],
  costs: [
